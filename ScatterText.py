...
def query_albums(albumList, artist):
...
query_albums(drake_albums_s1, 'drake')
query_albums(migos_albums_s1, 'migos')

d = {'artist': artist_col, 'album': album_col, 'song': song_col, 'lyrics': lyrics_col}
